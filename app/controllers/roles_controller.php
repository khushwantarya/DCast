 ...
 */
	...
	//this  function is used to get the roles by the requestAction from the navigation elements 
	public function admin_get_roles()
	{
		//get all the roles from the roles table
		$roles = $this->Role->find("list", array("fields" => array("id", "title")));
		//pr($roles);
		return $roles;
		exit;
	}
