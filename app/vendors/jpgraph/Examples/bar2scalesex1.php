...
$graph->SetY3Scale("lin");
$graph->yaxis->scale->SetGrace(30);
$graph->y2axis->scale->SetGrace(30);
$graph->y3axis->scale->SetGrace(30);
...
$ybplot3->value->Show();
$ybplot3->value->SetColor('darkred');
$ybplot3->SetFillColor('darkred');
$y3bplot = new GroupBarPlot(array($bplotzero,$ybplot2));
